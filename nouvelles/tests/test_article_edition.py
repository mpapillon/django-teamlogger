...
class ArticleEditionTestCase(TestCase):
    ...
    def test_get_not_logged(self):
        response = self.client.get(reverse('edit', kwargs={"slug": "lorem-ipsum-dolor-sit-amet"}))
    ...
    def test_post_not_logged(self):
        response = self.client.post(reverse('edit', kwargs={"slug": "lorem-ipsum-dolor-sit-amet"}), {
